(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.janDatav = factory(global.Vue, global.crypto));
  ...
  function render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      class: "icon-wrapper",
      style: vue.normalizeStyle(_objectSpread2({}, $props.style))
    }, [(vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$5, [vue.createElementVNode("use", {
      href: $setup.iconName
    }, null, 8
    /* PROPS */
    , _hoisted_2$4)]))], 4
  ...
  script$6.__file = "src/components/Icon/Icon.vue";
  ...
  script$5.__file = "src/components/SvgAnimation/SvgAnimation.vue";
  ...
  var script$4 = {
    ...
    setup(ctx) {
      const outsideColorAnimation = vue.computed(() => "".concat(ctx.outsideColor, ";").concat(ctx.insideColor, ";").concat(ctx.outsideColor));
      const insideColorAnimation = vue.computed(() => "".concat(ctx.insideColor, ";").concat(ctx.outsideColor, ";").concat(ctx.insideColor));
      return {
  ...
  function render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [vue.createCommentVNode("   作用于当当前标签内 from to  可以用values代替   默认旋转中心0 0 记得调整  "), vue.createCommentVNode("        from=\"0 25 25\""), vue.createCommentVNode("        to=\"360 25 25\""), vue.createElementVNode("animateTransform", {
    ...
    /* PROPS */
    , _hoisted_4$2), vue.createCommentVNode("  变色"), vue.createElementVNode("animate", {
    ...
    , _hoisted_5$1)], 8
    /* PROPS */
    , _hoisted_3$3), vue.createElementVNode("circle", {
      cx: "25",
      cy: "25",
      r: "12",
      fill: "none",
      ...
      "stroke-linecap": "round"
    }, [vue.createCommentVNode("    from to  可以用values代替    "), vue.createCommentVNode("        from=\"360 25 25\""), vue.createCommentVNode("        to=\"0 25 25\""), vue.createElementVNode("animateTransform", {
      attributeName: "transform",
      type: "rotate",
    ...
    /* PROPS */
    , _hoisted_7$1), vue.createCommentVNode("  变色"), vue.createElementVNode("animate", {
      attributeName: "stroke",
    ...
    , _hoisted_6$1)], 8
    /* PROPS */
    , _hoisted_2$3)), vue.createElementVNode("div", _hoisted_9$1, [vue.renderSlot(_ctx.$slots, "default")])]);
  }
  ...
  script$4.__scopeId = "data-v-6a7d80ef";
  script$4.__file = "src/components/JanLoading/JanLoading.vue";
  ...
  var script$3 = {
    ...
    setup() {
      ...
      const path = vue.computed(() => "M5 5 L".concat(width.value - 5, " 5 L").concat(width.value - 5, " ").concat(height.value - 5, " L5 ").concat(height.value - 5, " Z"));
  ...
  const _withScopeId = n => (vue.pushScopeId("data-v-055086ef"), n = n(), vue.popScopeId(), n);

  const _hoisted_1$2 = ["width", "height"];
  const _hoisted_2$2 = ["id", "d"];
  const _hoisted_3$2 = ["id"];

  const _hoisted_4$1 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/vue.createElementVNode("stop", {
    offset: "0%",
    "stop-color": "#fff",
    "stop-opacity": "1"
  }, null, -1
  ...
  const _hoisted_5 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/vue.createElementVNode("stop", {
    offset: "100%",
    "stop-color": "#fff",
    "stop-opacity": "0"
  }, null, -1
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ...
      width: $setup.width,
      height: $setup.height
    }, [vue.createCommentVNode("  用矩形实现也可以    "), vue.createElementVNode("defs", null, [vue.createElementVNode("path", {
      id: $setup.pathId,
      d: $setup.path,
      fill: "none"
    }, null, 8
    /* PROPS */
    , _hoisted_2$2), vue.createCommentVNode("    fx/fy  内圈的圆心范围    cx/cy  外圈的圆心范围  r 辐射半径   "), vue.createElementVNode("radialGradient", {
    ...
    /* PROPS */
    , _hoisted_3$2), vue.createElementVNode("mask", {
      id: $setup.maskId
    }, [vue.createElementVNode("circle", {
      r: $props.starLength,
      cx: "0",
    ...
    , _hoisted_8)], 8
    /* PROPS */
    , _hoisted_7)]), vue.createElementVNode("use", {
      href: "#".concat($setup.pathId),
      "stroke-width": "1",
      stroke: $props.lineColor
    }, null, 8
    /* PROPS */
    , _hoisted_10), vue.createElementVNode("use", {
      href: "#".concat($setup.pathId),
      "stroke-width": "3",
    ...
    , _hoisted_11)], 8
    /* PROPS */
    , _hoisted_1$2)), vue.createElementVNode("div", _hoisted_12, [vue.renderSlot(_ctx.$slots, "default")])], 512
    /* NEED_PATCH */
    );
  }

  var css_248z$3 = ".jan-fly-box[data-v-055086ef] {\n  position: relative;\n  width: 100%;\n  height: 100%;\n}\n.jan-fly-box[data-v-055086ef] svg[data-v-055086ef] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}\n.jan-fly-box[data-v-055086ef] .jan-fly-box-content[data-v-055086ef] {\n  width: 100%;\n  height: 100%;\n  padding: 2px;\n  box-sizing: border-box;\n}";
  styleInject(css_248z$3);

  script$3.render = render$3;
  script$3.__scopeId = "data-v-055086ef";
  script$3.__file = "src/components/JanFlyBox/JanFlyBox.vue";
  ...
  var stringSlice$4 = functionUncurryThisRaw(''.slice);
  ...
  var hasOwnProperty_1 = Object.hasOwn || function hasOwn(it, key) {
    return hasOwnProperty$b(toObject(it), key);
  };
  ...
  */
  ...
  const _hoisted_2$1 = ["stroke", "stroke-width"];
  const _hoisted_3$1 = ["stroke", "stroke-width"];
  const _hoisted_4 = ["stroke", "stroke-width"];
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$1, [vue.createElementVNode("path", {
      class: "jan-logo1",
      stroke: $props.stroke,
    ...
    /* PROPS */
    , _hoisted_2$1), vue.createElementVNode("path", {
      class: "jan-logo2",
      stroke: $props.stroke,
      "stroke-width": $props.strokeWidth,
  ...
  var iteratorCreateConstructor = function (IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
    ...
    IteratorConstructor.prototype = objectCreate$1(IteratorPrototype$1, { next: createPropertyDescriptor(+!ENUMERABLE_NEXT, next) });
  ...
  var script = {
    ...
    setup(props) {
      const id = "base-scroll-list-".concat(v4());
      const {
        width,
        height
      } = useScreen(id);
      ...
      const handleHeader = config => {
        ...
        let usedWidth = 0;
        let usedColumnNum = 0; // 判断是否自定义width
        ...
        const _columnWidth = new Array(_headerData.length).fill(avgWidth); // _headerStyle.forEach((style,index) => {
        //   if (style.width){
        //     // usedWidth += +style.width.replace('px','')
      ...
      const handleRows = config => {
        ...
        const unusedHeight = height.value - headerHeight; // 如果rowNum大于实际数据长度,则以实际数据长度为准
      ...
      const startAnimation = async () => {
        ...
        const {
          ...
          moveNum,
          duration
        } = config; // 解决了首次数据加载显示不全问题  不能直接取config.data.length

        const totalLength = rowsData.value.length;
        if (totalLength < rowNum) return;
        const index = currentIndex.value;

        const _rowsData = cloneDeep_1(rowsData.value); // 将数据重新头尾连接
        // [a,b,c,d,e,f,g]
        //    1
        // [b,c,d,e,f,g,a]
        ...
        currentRowData.value = rows; // 先将所有行的高度还原

        rowHeights.value = new Array(totalLength).fill(avgHeight);
        const waitTime = 300;
        if (!isAnimationStart.value) return;
        await new Promise((resolve, reject) => setTimeout(resolve, waitTime)); // 将moveNum的行高度设置为0
        ...
        if (!isAnimationStart.value) return; // 延迟操作 sleep
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.headerData, (headerItem, i) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: "header-item base-scroll-list-text",
        key: headerItem + i,
        style: vue.normalizeStyle(_objectSpread2({
    ...
    }, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.currentRowData, (rowData, index) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        style: vue.normalizeStyle({
          ...
          background: rowData.rowIndex % 2 === 0 ? $setup.rowBg[1] : $setup.rowBg[0],
          fontSize: "".concat($setup.actualConfig.rowFontSize, "px"),
          color: $setup.actualConfig.rowColor
        })
      }, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(rowData.data, (colData, colIndex) => {
        return vue.openBlock(), vue.createElementBlock("div", {
